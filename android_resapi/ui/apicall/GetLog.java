...
public class GetLog extends GetRequest {
    ...
    protected ArrayList<Tag> getArrayListFromJSONString(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Tag thing = new Tag(jsonObject.getString("air"),
                                    jsonObject.getString("LED"),
                                    jsonObject.getString("msg1"),
    ...
    class Tag {
        ...
        public Tag(String Air, String led, String msg1, String msg2, String time, String weight) {
            air = Air;
            LED = led;
            sentence1 = msg1;
            sentence2 = msg2;
        ...
        public String toString() {
            return String.format("[%s] air: %s, LED: %s, msg1: %s, msg2: %s, weight: %s", timestamp, air, LED, sentence1, sentence2, Weight);
        }
    }
}
