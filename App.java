...
public class App implements RequestHandler<Document, String> {
    ...
    private String DYNAMODB_TABLE_NAME = "Loging2";
...
//        if (document.current.state.reported.weight.equals(document.previous.state.reported.weight) &&
//                document.current.state.reported.led1.equals(document.previous.state.reported.led1)&&
//                document.current.state.reported.air.equals(document.previous.state.reported.air)&&
//                document.current.state.reported.sentence1.equals(document.previous.state.reported.sentence1)&&
//                document.current.state.reported.sentence2.equals(document.previous.state.reported.sentence2)) {
//            return null;
//        }
        ...
        return this.dynamoDb.getTable(DYNAMODB_TABLE_NAME)
                .putItem(new PutItemSpec().withItem(new Item()
                        ...
                        .withString("LED", document.current.state.reported.led1)
                        .withString("air", document.current.state.reported.air)
                        .withString("msg1", document.current.state.reported.sentence1)
                        .withString("msg2", document.current.state.reported.sentence2)
